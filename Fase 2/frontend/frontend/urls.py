...
urlpatterns = [
    ...
    path("asignar", asignar , name="asignar"),#asignar cursos al usuario
    path('volv',volverA, name='volv'),
    path('volvUsu',volverU, name='volvUsu'),
    ...
    path('reporteG',carga_grafo, name='reporteG'),#carga de reporte de red de estudio
    path('reportePre',reporte_grafo, name='reportePre'),#carga de reporte red de estudio de prerrequisitos
    path('reportePreE',reporte_grafoEstu, name='reportePreE'),#carga de reporte red de estudio de usuario
]
